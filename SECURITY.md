...
`https://github.com/uditkumar123/hermex/security/advisories/new`). This opens a
...
- The app version (or commit) and Android version you tested against
...
This repository contains the Android client. Vulnerabilities in the
